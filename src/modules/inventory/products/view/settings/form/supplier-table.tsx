...
export function ProductSupplierTable<TData extends ProductSupplier, TValue>({
	columns,
	data,
	pageCount,
	...
	return (
		<>
			<div className="flex justify-between items-center gap-3 md:gap-0 mb-3">
				<div className="text-xl font-semibold">Assign Supplier</div>
				<CreateProductSupplierDialogue />
			</div>
